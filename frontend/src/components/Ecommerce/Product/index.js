...
const Product = () => {
  ...
  // Product Search Results will be put inside searchedProductList[]
  ...
  products.filter((product) => {
    ...
    let condition = product.condition.toLowerCase().replace(/\s+/g, " ").trim();
  ...
  return (
    <>
      {isLoading ? (
        <Loader />
      ) : // Check if there's any searched result, if none, display a not found text
